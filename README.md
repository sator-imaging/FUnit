...
With FUnit.Directives package, you can *include* external file into file-based app project by adding special directive `#warning include <path to the file>`.

```cs
#:package FUnit@*
#:package FUnit.Directives@*

#warning include ./path/to/external-file.cs
